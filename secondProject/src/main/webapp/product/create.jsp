...
<link rel="stylesheet" type="text/css" href="<%=cp%>/product/css1/style.css"/>
<link rel="stylesheet" type="text/css" href="<%=cp%>/product/css1/created.css"/>

<script type="text/javascript" src="<%=cp%>/product/js/create.js"></script>
