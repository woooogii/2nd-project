...
<link rel="stylesheet" type="text/css" href="<%=cp %>/mthree/style/style.css"/>
<link rel="stylesheet" type="text/css" href="<%=cp %>/mthree/style/list.css"/>
				...
				<c:forEach var="dto" items="${allProductLists }">
					<div style="margin-bottom: 10px; align-items: center;">
						<div style="width: 280px; height: 280px; text-align: center;">
							<a href="<%=cp%>/joden/cabin/shop/productDetail.gos?productNum=?${dto.productNum}">
